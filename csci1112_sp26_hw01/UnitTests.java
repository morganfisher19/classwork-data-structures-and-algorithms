...
class UnitTests {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Begin Block 1 Unit Tests");
        ...
        fail = false;
        System.out.println("Begin Block 2 Unit Tests");
        ...
        fail = false;
        System.out.println("Begin Block 3 Unit Tests");
    ...
    //--------------------------------------------------------------------
    /// Validates that getBestWord handles an empty dictionary
